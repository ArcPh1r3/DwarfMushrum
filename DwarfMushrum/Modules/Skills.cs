...
namespace DwarfMushrum.Modules
{
    internal static class Skills
    {
        ...
        {
            GameObject prefab = Prefabs.bodyPrefab;
            ...
            AddPrimarySkills(prefab, mySkillDef);
            ...
            AddSecondarySkills(prefab, mySkillDef);
            ...
            AddUtilitySkills(prefab, mySkillDef);

            // ?
            AddSpecialSkills(prefab, mySkillDef);
        }
